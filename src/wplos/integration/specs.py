...
class ConsumerRegistry:
    ...
    def __init__(self, specs: tuple[EventSpec, ...]) -> None:
        self._specs = {spec.event_type: spec for spec in specs}
        if len(self._specs) != len(specs):
            raise ValueError("duplicate event spec")
        self._handlers: dict[str, dict[str, Consumer]] = {}

    def register(self, event_type: str, consumer_name: str, handler: Consumer) -> None:
    ...
    def spec_for(self, event_type: str) -> EventSpec:
