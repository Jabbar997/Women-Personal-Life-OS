...
class ReasonCode(StrEnum):
    ...
    GUARDIAN_ASSESSMENT_FORGED = "GUARDIAN_ASSESSMENT_FORGED"
    GUARDIAN_ASSESSMENT_SUPERSEDED = "GUARDIAN_ASSESSMENT_SUPERSEDED"
    GUARDIAN_ASSESSMENT_STALE = "GUARDIAN_ASSESSMENT_STALE"
